...
모든 migration을 순서대로 적용해야 하며, 개선 기능에는 `202606140008`부터 `202606140012`까지의 migration이 필요합니다. 익명 기록 연결 기능을 사용하려면 Supabase Auth에서 Anonymous Sign-Ins를 활성화합니다.
...
- 매주 일요일 `15:00 KST`: 다음 월요일부터 일요일까지 7일 중 비어 있는 날짜를 보충
- 매일 `23:30 KST`: 다음 날짜의 예약 문제를 공개
- `SCRAPE_SOURCE_URLS`에 쉼표로 구분한 공개 문제 모음 URL을 설정하면 웹 문제를 참고해 서비스 문안으로 재구성
